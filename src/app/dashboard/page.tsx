...
export default function DashboardPage() {
  ...
  const handleCreateSite = async (e: React.FormEvent) => {
    ...
    if (!validateSubdomain(newSite.subdomain)) {
      setError('L\'URL doit être en minuscules et peut contenir des lettres, des chiffres et des tirets.')
      return
    }
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    L'URL doit être en minuscules et peut contenir des lettres, des chiffres et des tirets.
                  </p>
                </div>
              </div>
